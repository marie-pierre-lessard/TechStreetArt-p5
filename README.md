...
The web app as a whole constitutes a styled art viewer with responsive image carousel, reset button, saving function for the user's art, and some text content. Everything outside of the enhanced kaleidoscope function can be reused to create other games. The enhanced kaleidoscope function is a derivative work of the following P5 example, which I modified in order to create a kaleidoscope that was complete with a colour picker. 
