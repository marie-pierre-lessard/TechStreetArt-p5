...
* If I had used the `resize()` method of the `p5.Image` object instead of solving the problem mathematically and setting both a width and a height, there may not have been a problem with Unsplash. However, it is unlikely that I will update this assignment in order to adapt it to Unsplash. I might replace the Unsplash endpoints by file paths in the future.
