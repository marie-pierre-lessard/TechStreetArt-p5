...
The pictures are no longer the class project's pictures, which had different orientations, but the same number of pixels. The new images are picked randomly by [Unsplash](https://unsplash.com), which has a very permissive [open-source license](https://unsplash.com/license). This license applies to any image modified with the art game.
