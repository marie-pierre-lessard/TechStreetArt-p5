...
The pictures are no longer the class project's pictures, which had different orientations, but the same number of pixels. The new pictures are picked randomly by [Unsplash](https://unsplash.com), which has very permissive [open-source license](https://unsplash.com/license).
