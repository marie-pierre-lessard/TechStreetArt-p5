...
* a [forum thread](https://forum.processing.org/two/discussion/13051/how-do-i-bind-p5-canvas-to-an-html-page.html) that  illustrated the use of P5's parent() method better than the P5 reference pages. 
